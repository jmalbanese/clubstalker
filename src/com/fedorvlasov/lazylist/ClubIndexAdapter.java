...
public class ClubIndexAdapter extends BaseAdapter {
    
    private Activity activity;
    private Entities entities;
    private static LayoutInflater inflater=null;
    
    public ClubIndexAdapter(Activity a, Entities e) {
        activity = a;
        entities=e;
    ...
    public View getView(int position, View convertView, ViewGroup parent) 
    {
        ...
        if(convertView==null)
            vi = inflater.inflate(R.layout.clubitem, null); // item defines a "text" and "image" view
       ...
       String theComments = TextUtils.truncateWithDots(entities.get(position).getComments(), Constants.MASSAGE_INDEX_NUM_CHARS);
