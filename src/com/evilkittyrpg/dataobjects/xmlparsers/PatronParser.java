...
import com.evilkittyrpg.dataobjects.*;
 ...
 public class PatronParser  extends BaseFeedParser {
...
//	static final String ENTRY = "entry";
	...
	private final String TAG = "PatronParser";

	public PatronParser(String feedUrl) 
	{
		super(feedUrl);
	}

	public ArrayList<Patron> parse() {
		final Entity currentObj = new Entity();
		RootElement root = new RootElement(BLOCK);
		final ArrayList<Patron> currentObjs = new ArrayList<Patron>();
		Element item = root.getChild(ENTRY);
		
		item.setEndElementListener(new EndElementListener(){
			public void end() 
			{
			  // Patron constructor will transfer this entity to its internal entity
				currentObjs.add( new Patron(currentObj));
			}
		});
